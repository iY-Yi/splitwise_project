        ...
        {/* { this.state.authFlag === false && <div class="alert alert-danger">Log in failed!</div>} */}
          <div class = "row">
            ...
            <div class="col-md-4">
              ...
              <input class="form-control" type="text" id="name" name="name" value={this.state.user.name} readonly="readonly" onChange={this.handleChange}/><br/>
              <label for="email">Email:</label><br/>
              <input class="form-control" type="email" id="email" name="email" value={this.state.user.email} onChange={this.handleChange}/><br/>
              <label for="phone">Phone Number:</label><br/>
              <input class="form-control" type="tel" id="phone" name="phone" value={this.state.user.phone} onChange={this.handleChange}/><br/> 
            </div>
            <div class="col-md-4">
              <label for="currency">Default currency:</label><br/>
              <select class="form-control" name="currency" id="currency" value={this.state.user.currency} onChange={this.handleChange}>
